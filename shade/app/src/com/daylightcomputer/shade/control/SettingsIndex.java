...
public final class SettingsIndex {
    ...
    private static final Entry[] ALL = {
        e("PIN & screen lock", "in Security",
                "pin passcode password code lock unlock screen lock fingerprint touch id face id biometric pattern swipe secure security",
                Settings.ACTION_SECURITY_SETTINGS),
        e("Wi-Fi networks", "in Network & internet",
                "wifi wi-fi wireless internet network networks join password router forget hotspot not working",
                Settings.ACTION_WIFI_SETTINGS),
        e("Bluetooth devices", "in Connected devices",
                "bluetooth pair pairing earbuds headphones airpods beats buds headset speaker keyboard mouse connect disconnect",
        ...
        e("Screen & brightness", "in Display",
                "display screen brightness dim sleep timeout turns off dark light auto rotate rotation font bigger smaller text size",
                Settings.ACTION_DISPLAY_SETTINGS),
        e("Sounds & volume", "in Sound",
                "sound volume ringtone mute silent vibrate vibration haptics ringer alarm sounds media loud quiet",
        ...
        e("Storage", "in Storage",
                "storage space full free gb memory disk room delete photos files",
        ...
        e("Date & time", "in System",
                "date time clock timezone zone hour am pm automatic 24 24-hour format",
        ...
        e("Software update", "in System",
                "update upgrade software version new sol:os os install patch",
                "android.settings.SYSTEM_UPDATE_SETTINGS"),
        e("About this tablet", "in About",
                "about device info serial number model version android sol:os legal ip mac address regulatory",
        ...
        e("Captions & subtitles", "in Accessibility",
                "captions subtitles closed caption cc hearing",
                "android.settings.CAPTIONING_SETTINGS"),
        e("Home app", "in Apps",
                "home launcher home screen default desktop",
                "android.settings.HOME_SETTINGS"),
        e("Screen saver", "in Display",
                "screen saver screensaver dream clock while charging",
