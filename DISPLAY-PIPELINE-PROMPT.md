...
- Daylight DC-1: 10.5″ "LivePaper" — a **transflective TN LCD** on an
  **IGZO oxide TFT** backplane, **no color filter array**, **8-bit**,
  1600×1200 (4:3), ~190 PPI, variable refresh — measured modes
  6/10/15/24/30/45/60/72/90/120 Hz, idle 24 Hz, touch/pen boosts to 120 Hz
  (motion/refresh has its own investigation: REFRESH-MOTION-PROMPT.md). E-paper-class but
